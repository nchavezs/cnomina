...
<head>
    ...
    <link rel="stylesheet" href="assets/css/material-dashboard.css?v=4.2.0"/>
    <link rel="stylesheet" href="assets/js/plugins/animate/adp.css">
    <link rel="stylesheet" href="assets/css/sweetalert2.min.css?v=4.2.0"/>
</head>
...
<body>
    ...
    <script src="assets/js/periodo.js?v=4.2.0"></script>
</body>
