...
<head>
    ...
    <link rel="stylesheet" href="assets/css/material-dashboard.css?v=3.7.5"/>
    <link rel="stylesheet" href="assets/js/plugins/animate/adp.css">
    <link rel="stylesheet" href="assets/css/sweetalert2.min.css?v=3.7.5"/>
</head>
...
<body>
    ...
    <script src="assets/js/periodo.js?v=3.7.5"></script>
</body>
