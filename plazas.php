...
<body class="">
                        ...
                        <div class="card-body">
                            <div class="msn-mostrar">
                                ...
                                <!-- <label onclick="exportar_plazas();" class="btn-mostrar"><i
                                        ...
                                        <a href="./assets/docs/plazas.xlsx?v=3.6.1" download class="btn-mostrar"><i class="material-icons">line_style</i>Plantilla</a>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/plazas.js?v=3.6.1"></script>
