...
<body>
                            ...
                            <div class="msn-mostrar">
                                ...
                                if(in_array( 37, rol())){
                                    echo '
                                        ...
                                        <a href="./assets/docs/plazas.xlsx?v=3.8.4" download class="btn-mostrar"><i class="material-icons">line_style</i>Plantilla</a>
                                    ';
                                }else{
   ...
   <script src="assets/js/plazas.js?v=3.8.4"></script>
