...
<head>
    ...
    <link rel="stylesheet" href="assets/css/material-dashboard.css?v=3.6.6"/>
    ...
    <link rel="stylesheet" href="assets/css/sweetalert2.min.css?v=3.6.6"/>
...
<body>
                                ...
                                if (rol() == 1) {
                                    echo '<button id="nuevo-empleado" class="btn-mostrar"><i class="material-icons">add_circle_outline</i>
                                        ...
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="assets/docs/empleado/importar/empleado.xlsx?v=3.6.6" class="dropdown-item"> <i class="material-icons" >check</i>Por # de plaza</a>
                                                <a href="assets/docs/empleado/actualizar/empleado.xlsx?v=3.6.6" class="dropdown-item"> <i class="material-icons" >check</i>Por puesto y departamento</a>
                                            </div>
                                        </span>
                                    ';
                                }
    ...
    <script src="assets/js/material-dashboard.js?v=3.6.6" type="text/javascript"></script>
    ...
    <script src="assets/js/sesion.js?v=3.6.6"></script>
    <script src="assets/js/registrar.js?v=3.6.6"></script>
</body>
