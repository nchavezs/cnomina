...
-- SI HAY MAS PLAZAS CON MISMO RFC
SELECT RFC, COUNT(*)
FROM Plaza
GROUP BY RFC
HAVING COUNT(*) > 1;

-- CUANDO HACEN MOVIMIENTOS EL PRIMER DIA DEL AÑO
SELECT * FROM `Historial_Plaza` WHERE fecha_inicio >= "2025-01-01" and YEAR(fecha_fin) = 2024