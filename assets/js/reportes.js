...
$(document).ready(function () {
    ...
    // $("#departamento_multiple").change(function(){
    //     alert(this.value);
    //     if(this.value == null){
    ...
    // $("").click(function () {
    //     $("#puesto :selected").each(function(){
    //         puestos.push(this.text);
    //     });
    // });
...
function depa_change_multiple() {
    $("#departamento_multiple").on("change", function () {
        let departamentos = [0];
    $("#departamento_multiple :selected").each(function(){
