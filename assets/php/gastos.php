...
if (mysqli_num_rows($consulta) == 0) {
    echo '<div class="vacia">
               ...
               <h1>Nada registrado</h1>
					<div class="chat-nuevo">
						...
						<p id="' . $id . '-" onclick="gastos(this.id);">Nuevo gasto médico</p>
					</div>
				</div>';
    ...
    echo '<div class="row">
					...
					<div class="col-6">
						<div class="btn btn-secondary btn-sm regresar " id="' . $id . '-" onclick="gastos(this.id)"><i class="material-icons">add</i> Nuevo </div>
						</div>
					</div>
				</div>';
}
