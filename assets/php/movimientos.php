    ...
    echo '<div class="vacia">
               ...
               <h2>Nada registrado</h2>
					<div class="chat-nuevo">
						...
						<p onclick="'.$bloqueo.'">Nuevo movimiento</p>
					</div>
				</div>';
} else {
    echo '<div class="p-2">
			...
			<div class="ver_opciones">
				<div class="btn btn-secondary btn-sm" onclick="'.$bloqueo.'"><i class="material-icons">add</i> Nuevo movimiento</div></div>	
			</div>
