...
$sql1 = "SELECT * FROM Usuario WHERE RFC = (SELECT RFC FROM Vacacion WHERE id_vacacion = " . $id . ") LIMIT 1";
...
$html = '<div class="p-2">
		...
		<div class="pie">
			<div class="btn btn-secondary btn-sm" onclick="verVacaciones(\''.$usuario["RFC"].'\');"><i class="material-icons">arrow_back</i> Regresar </div>
		</div>';
