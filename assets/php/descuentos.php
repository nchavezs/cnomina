...
if (mysqli_num_rows($consulta) == 0) {
    echo '<div class="vacia">
			...
			<div class="chat-nuevo">
				...
				<p onclick="'.$bloqueo.'">Nuevo descuento</p>
			</div>
		</div>';
} else {
    echo '<div class="p-2">
	...
	<div class="ver_opciones">
			<div class="btn btn-secondary btn-sm" onclick="'.$bloqueo.'"><i class="material-icons">add</i> Nuevo descuento</div>
		</div>
