<?php
   ...
   $sql = "SELECT * FROM Pase WHERE RFC = '".$id."'";
   $consulta = mysqli_query($conexion, $sql);
	...
	if(mysqli_num_rows($consulta) == 0){
		...
		echo'<div class="centrado2 row">
					...
					<div class="col-4">
						<select id="categoria" class="custom-select sources">
							<option value="0" selected="true">Entrada</option>
				...
				<div class="card card-profile ">
					<div class="card-header card-header-primary">
						<h4 class="card-title ">Pases</h4>
						<p class="card-category">Empleado: '.$nombre.'</p>
					</div>
					<div class="card-body">
