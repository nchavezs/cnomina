<div class="p-5 bg-light">
    ...
    <img src="assets/img/key.svg" alt="" width="20%">
    ...
    <p class="pt-4"><a class="btn btn-primary btn-sm text-lowercase" href="mailto:info@consultanomina.com">
        <i class="material-icons">send</i> contacto@consultanomina.com</a>
    </p>
