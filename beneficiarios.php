...
<head>
	...
	<link href="assets/css/material-dashboard.css?v=4.1" rel="stylesheet" />
	<link href="assets/css/animate.css" rel="stylesheet" />
	<link href="assets/css/select2.css?v=4.1" rel="stylesheet" />
...
<body class="">
	...
	<link href="assets/css/sweetalert2.min.css?v=4.1" rel="stylesheet" />
	...
	<script src="assets/js/material-dashboard.js?v=4.1" type="text/javascript"></script>
	<script src="assets/js/plugins/izitoast/js/iziToast.js"></script>
	<script src="assets/js/sesion.js?v=4.1"></script>
	<script src="assets/js/block.js"></script>
	<script src="assets/js/beneficiarios.js?v=4.1"></script>
	<script src="assets/js/mensajes-user.js?v=4.1"></script>
