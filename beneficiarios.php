...
<head>
	...
	<link href="assets/css/material-dashboard.css?v=3.7.9" rel="stylesheet" />
	<link href="assets/css/animate.css" rel="stylesheet" />
	<link href="assets/css/select2.css?v=3.7.9" rel="stylesheet" />
...
<body class="">
	...
	<link href="assets/css/sweetalert2.min.css?v=3.7.9" rel="stylesheet" />
	...
	<script src="assets/js/material-dashboard.js?v=3.7.9" type="text/javascript"></script>
	<script src="assets/js/plugins/izitoast/js/iziToast.js"></script>
	<script src="assets/js/sesion.js?v=3.7.9"></script>
	<script src="assets/js/block.js"></script>
	<script src="assets/js/beneficiarios.js?v=3.7.9"></script>
	<script src="assets/js/mensajes-user.js?v=3.7.9"></script>
