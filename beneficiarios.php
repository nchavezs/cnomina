...
<head>
	...
	<link href="assets/css/select2.css?v=3.7.3" rel="stylesheet" />
...
<body class="">
	...
	<script src="assets/js/sesion.js?v=3.7.3"></script>
	<script src="assets/js/block.js"></script>
	<script src="assets/js/beneficiarios.js?v=3.7.3"></script>
	<script src="assets/js/mensajes-user.js?v=3.7.3"></script>
