...
<head>
	...
	<link href="assets/css/select2.css?v=3.8.4" rel="stylesheet" />
...
<body class="">
	...
	<script src="assets/js/sesion.js?v=3.8.4"></script>
	<script src="assets/js/block.js"></script>
	<script src="assets/js/beneficiarios.js?v=3.8.4"></script>
	<script src="assets/js/mensajes-user.js?v=3.8.4"></script>
